...
public class LevelSwitch : MonoBehaviour
{
    ...
    private Transform l1, l2, l3, l4, l5;
    ...
    public void levelPressed(string direction)
    {
        ...
        /*if(buttonTime >= 30)//make buttons appear to be pressed for 30 frames
        {
            leftSlider.sprite = lSlide;
            rightSlider.sprite = rSlide;
        }*/
        buttonTime++;
    ...
    {
        /* COORDS
            BACK - Vector2.MoveTowards(l3.position, new Vector2(0, 0.5f), 0.02f); new Vector3(l3.position.x, l3.position.y, 3);
            RIGHT - Vector2.MoveTowards(l2.position, new Vector2(1, 0.185f), 0.02f); new Vector3(l2.position.x, l2.position.y, 2);
