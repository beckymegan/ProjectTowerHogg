...
public class CharacterSelect : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (gVar.readyPlayers == gVar.requiredReadyPlayers && gVar.requiredReadyPlayers > 1 && Input.GetButton("Start")) //more than one player have joined and all joined players are ready to play
        {
